...
export const metadata: Metadata = {
  title: "Veritate | Ghostbyte",
  alternates: {
    canonical: "https://ghostbyte.dev/work/veritate",
  },
};
...
export default async function VeritatePage(props: {
  ...
  return (
    <div>
      <ProjectHero title="Veritate Website" url="https://veritate.at" />
      ...
      <MoreProjects lang={lang} projectsToShow={["Pixelix", "Together"]} />
    </div>
  );
}
